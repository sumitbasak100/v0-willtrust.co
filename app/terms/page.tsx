    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 lg:py-24">
        ...
        <div className="prose prose-slate max-w-none text-muted-foreground space-y-6">
          ...
          <h2 className="text-foreground font-serif text-2xl mt-8">Educational Purposes Only</h2>
          <p>
          ...
          <h2 className="text-foreground font-serif text-2xl mt-8">User Responsibility</h2>
          <p>
          ...
          <h2 className="text-foreground font-serif text-2xl mt-8">Limitation of Liability</h2>
          <p>
