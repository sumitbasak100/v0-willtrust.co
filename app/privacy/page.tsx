    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 lg:py-24">
        ...
        <div className="prose prose-slate max-w-none text-muted-foreground space-y-6">
          ...
          <h2 className="text-primary font-serif text-2xl mt-8">Information Collection</h2>
          <p>
          ...
          <h2 className="text-primary font-serif text-2xl mt-8">Security</h2>
          <p>
          ...
          <h2 className="text-primary font-serif text-2xl mt-8">Third Parties</h2>
          <p>
